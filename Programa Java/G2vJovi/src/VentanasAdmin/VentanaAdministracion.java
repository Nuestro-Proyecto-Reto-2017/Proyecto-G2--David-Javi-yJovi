...
public class VentanaAdministracion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mAdministrarVehiculos = new javax.swing.JMenu();
        mAdminVehiculos = new javax.swing.JMenuItem();
        mPerfil = new javax.swing.JMenu();
        mAdministrarperfil = new javax.swing.JMenuItem();
        ...
        mAdministrarVehiculos.setText("Administrar Vehiculos");

        mAdminVehiculos.setText("Admin Vehiculos");
        mAdminVehiculos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mAdminVehiculosActionPerformed(evt);
            }
        });
        mAdministrarVehiculos.add(mAdminVehiculos);

        jMenuBar1.add(mAdministrarVehiculos);

        mPerfil.setText("Perfil");

        mAdministrarperfil.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/user2.png"))); // NOI18N
        mAdministrarperfil.setText("Administrar Perfil");
        mAdministrarperfil.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mAdministrarperfilActionPerformed(evt);
            }
        });
        mPerfil.add(mAdministrarperfil);
    ...
    private void mAdminVehiculosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mAdminVehiculosActionPerformed
        g2vjovi.G2vJovi.abrirVentanaVehiculos();
    }//GEN-LAST:event_mAdminVehiculosActionPerformed

    private void mAdministrarperfilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mAdministrarperfilActionPerformed
      g2vjovi.G2vJovi.abrirventanaUsuario();
    }//GEN-LAST:event_mAdministrarperfilActionPerformed
    ...
    private javax.swing.JMenuItem mAdminVehiculos;
    private javax.swing.JMenu mAdministrarPartes;
    private javax.swing.JMenu mAdministrarTrabajadores;
    private javax.swing.JMenu mAdministrarVehiculos;
    private javax.swing.JMenuItem mAdministrarperfil;
