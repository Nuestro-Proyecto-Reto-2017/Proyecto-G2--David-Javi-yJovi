 ...
 * @author 1gprog02
 */
public class ModificarCentro extends javax.swing.JDialog {
    private ArrayList <Centro> centroEncontrado;
    private G2vJovi main = new G2vJovi();
    private String vnombreC;
    /**
     * Crea el form NuevoTrabajador
     */
    public ModificarCentro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
    }
    public ModificarCentro(java.awt.Frame parent, boolean modal,ArrayList centroEncontrado) {
        super(parent, modal);
        initComponents();
        this.centroEncontrado=centroEncontrado;
        setLocationRelativeTo(null);
        rellenarVentana();
        vnombreC = tfNombre.getText().toUpperCase();
    }
    private void rellenarVentana(){
        tfNombre.setText(centroEncontrado.get(0).getNombre());
        tfCalle.setText(centroEncontrado.get(0).getCalle());
        tfNumero.setText(centroEncontrado.get(0).getNumero());
        tfCodigoPostal.setText(centroEncontrado.get(0).getCodigoPostal());
        tfCiudad.setText(centroEncontrado.get(0).getCiudad());
        tfProvincia.setText(centroEncontrado.get(0).getProvincia());
        tfTelefono.setText(centroEncontrado.get(0).getTelefono());
    }
    /**
    ...
    private void initComponents() {
        ...
        bCrearCentro.setText("Modificar Centro");
 ...
 */
    private void bCrearCentroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCrearCentroActionPerformed
            ...
            main.procUpdateCentro(vnombreC,cCentro);
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        G2vJovi.cerrarVentanaModificarCentro();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarCentro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModificarCentro dialog = new ModificarCentro(new javax.swing.JFrame(), true);
