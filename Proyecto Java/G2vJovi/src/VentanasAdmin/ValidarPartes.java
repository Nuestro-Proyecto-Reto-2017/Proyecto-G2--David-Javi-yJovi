...
public class ValidarPartes extends javax.swing.JDialog {
    ...
    private void disableBotones(){
        ...
        if(listaPartes.size()>0){
            if(listaPartes.get(0).getTipoParte().compareToIgnoreCase("R")==0 ){
                bModificar0.setEnabled(true);
                bEliminar0.setEnabled(true);
                bValidar0.setEnabled(true);
            }
            if(listaPartes.size()>1){
                if(listaPartes.get(1).getTipoParte().compareToIgnoreCase("R")==0){
                    bModificar1.setEnabled(true);
                    bEliminar1.setEnabled(true);
                    bValidar1.setEnabled(true);
                    }
                if(listaPartes.size()>2){
                    if(listaPartes.get(2).getTipoParte().compareToIgnoreCase("R")==0){
                        bModificar2.setEnabled(true);
                        bEliminar2.setEnabled(true);
                        bValidar2.setEnabled(true);
                    }
                    if(listaPartes.size()>3){
                        if(listaPartes.get(3).getTipoParte().compareToIgnoreCase("R")==0){
                            bModificar3.setEnabled(true);
                            bEliminar3.setEnabled(true);
                            bValidar3.setEnabled(true);
                        }
                        if(listaPartes.size()>4){
                            if(listaPartes.get(4).getTipoParte().compareToIgnoreCase("R")==0){
                                bModificar4.setEnabled(true);
                                bEliminar4.setEnabled(true);
                                bValidar4.setEnabled(true);
                            }
                            if(listaPartes.size()>5){
                                if(listaPartes.get(5).getTipoParte().compareToIgnoreCase("R")==0){
                                    bModificar5.setEnabled(true);
                                    bEliminar5.setEnabled(true);
                                    bValidar5.setEnabled(false);
                                }
                                if(listaPartes.size()>6){
                                    if(listaPartes.get(6).getTipoParte().compareToIgnoreCase("R")==0){
                                        bModificar6.setEnabled(true);
                                        bEliminar6.setEnabled(true);
                                        bValidar6.setEnabled(true);
                                    }
                                    if(listaPartes.size()>7){
                                        if(listaPartes.get(7).getTipoParte().compareToIgnoreCase("R")==0){
                                            bModificar7.setEnabled(true);
                                            bEliminar7.setEnabled(true);
                                            bValidar7.setEnabled(true);
                                        }
                                        if(listaPartes.size()>8){
                                            if(listaPartes.get(8).getTipoParte().compareToIgnoreCase("R")==0){
                                                bModificar8.setEnabled(true);
                                                bEliminar8.setEnabled(true);
                                                bValidar8.setEnabled(true);
                                            }
                                            if(listaPartes.size()>9){
                                                if(listaPartes.get(9).getTipoParte().compareToIgnoreCase("R")==0){
                                                    bModificar9.setEnabled(true);
