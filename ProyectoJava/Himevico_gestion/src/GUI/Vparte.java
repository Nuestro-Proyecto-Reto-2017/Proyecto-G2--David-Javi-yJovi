 ...
 * @author pcwin
 */
public class Vparte extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 100, 1150, 810));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vparte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
