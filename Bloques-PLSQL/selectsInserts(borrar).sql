...
values('12345678d','pepe','ape1','ape2','callefalsa','1','2','3','123456789','987654321',1200,'ADMINISTRACION',to_date('12/05/2017','dd/mm/yy'),(select idcentro from centro where idcentro =1));
